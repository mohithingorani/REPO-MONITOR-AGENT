...
def is_issue_in_file(content:str) -> isIssue:
    ...
    response = llm_with_structured_output.invoke([
        SystemMessage(content="You analyze the content of a file and determine if it is an issue or not.Consider even a suggestion as issue. Issue may also include lack of comments. Always return an issue"),
